...
Enter the `linux-nxp-debix` directory and switch to the corresponding branch. Take the **lf_5.15.71-debix_model_ab branch** as an example:  
...
* debix
  ...
  remotes/origin/lf_6.1.22-debix_model_ab
  remotes/origin/lf_6.6.36-debix_model_ab


```

c. Switch branches: `git checkout lf_5.15.71-debix_model_ab`  

```shell
ljm@polyhex:~/workstation/Github/linux-nxp-debix$ git checkout lf_5.15.71-debix_model_ab
Updating files: 100% (55080/55080), done.
Branch 'lf_5.15.71-debix_model_ab' set up to track remote branch 'lf_5.15.71-debix_model_ab' from 'origin'.
Switched to a new branch 'lf_5.15.71-debix_model_ab'
