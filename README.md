...
Enter the `linux-nxp-debix` directory and switch to the corresponding branch. Take the **lf_5.10.72-debix_model_a branch** as an example:  
...
c. Switch branches: `git checkout lf_5.10.72-debix_model_a`  

```shell
ljm@polyhex:~/workstation/Github/linux-nxp-debix$ git checkout lf_5.10.72-debix_model_a
Updating files: 100% (55080/55080), done.
Branch 'lf_5.10.72-debix_model_a' set up to track remote branch 'lf_5.10.72-debix_model_a' from 'origin'.
Switched to a new branch 'lf_5.10.72-debix_model_a'
