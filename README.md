...
Enter the `linux-nxp-debix` directory and switch to the corresponding branch. Take the **lf_6.1.22-debix_model_ab branch** as an example:  
...
c. Switch branches: `git checkout lf_6.1.22-debix_model_ab`  
