...
static int skw_sdio_probe(struct sdio_func *func, const struct sdio_device_id *id)
{
	...
	skw_sdio_info("%s: func->class=%x, vendor=0x%04x, device=0x%04x, "
...
static const struct sdio_device_id skw_sdio_ids[] = {
	...
	//John_gao add wifi pid vid
	//cat /sys/bus/sdio/devices/mmc1\:8800\:1/device
	//cat /sys/bus/sdio/devices/mmc1\:8800\:1/vendor
	{SDIO_DEVICE(0x0, 0x0)},
	{SDIO_DEVICE(0x1ffe, 0x6160)},
